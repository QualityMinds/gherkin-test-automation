...
dependencies {
    api(project(":Core"))
    api(project(":Utils"))
    implementation("in.jlibs:jlibs-xmldog:3.0.1")
}
...
publishing {
    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("GTA Validation")
                description.set(
                    "The Validation module of GTA."
                )
                url.set("https://github.com/QualityMinds/gherkin-test-automation/tree/master/Validation")
                licenses {
                    license {
